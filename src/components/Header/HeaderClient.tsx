...
export default function Header({ dataGeneral }: HeaderProps) {
  ...
  const menus = dataGeneral?.menu2.detalles || [];
        ...
        <div className="md:max-w-5xl w-full mx-auto">
          <div className="flex justify-between items-center py-1">
            ...
            <div className="flex items-center gap-3 py-2 pe-2">
              <Link href="/carrito" className="relative lg:inline-flex items-center p-2 text-JisaCyan hidden" aria-label="Ver carrito">
                <CartIcon size={20} />
                {cartItems.length > 0 && (
              ...
              <button
                type="button"
                onClick={() => open("header")}
                className="inline-flex items-center gap-2 bg-JisaCyan hover:bg-JisaCyan text-white font-semibold px-4 py-2 rounded-full transition-colors"
